...
def showPost(id_post):
    ...
    title_post = dbase.getPost(id_post)

    if not title_post['title']:
        abort(404)
    
    return render_template('post.html', menu=dbase.getMenu(), title=title_post['title'], post=title_post['text'])
